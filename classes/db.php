...
class DB
{
	...
	*/
	...
	protected static function _fillTablesList( $conn )
	{
		...
		{
			$dalTables[$conn->connId][] = array("name" => "global_status", "varname" => "dbusers_at_127_0_0_1__global_status", "altvarname" => "global_status", "connId" => "dbusers_at_127_0_0_1", "schema" => "", "connName" => "dbusers at 127.0.0.1");
			...
			$dalTables[$conn->connId][] = array("name" => "Home_v1091_settings", "varname" => "dbusers_at_127_0_0_1__Home_v1091_settings", "altvarname" => "Home_v1091_settings", "connId" => "dbusers_at_127_0_0_1", "schema" => "", "connName" => "dbusers at 127.0.0.1");
			$dalTables[$conn->connId][] = array("name" => "home_v1091uggroups", "varname" => "dbusers_at_127_0_0_1__home_v1091uggroups", "altvarname" => "home_v1091uggroups", "connId" => "dbusers_at_127_0_0_1", "schema" => "", "connName" => "dbusers at 127.0.0.1");
			$dalTables[$conn->connId][] = array("name" => "home_v1091ugmembers", "varname" => "dbusers_at_127_0_0_1__home_v1091ugmembers", "altvarname" => "home_v1091ugmembers", "connId" => "dbusers_at_127_0_0_1", "schema" => "", "connName" => "dbusers at 127.0.0.1");
			$dalTables[$conn->connId][] = array("name" => "home_v1091ugrights", "varname" => "dbusers_at_127_0_0_1__home_v1091ugrights", "altvarname" => "home_v1091ugrights", "connId" => "dbusers_at_127_0_0_1", "schema" => "", "connName" => "dbusers at 127.0.0.1");
			$dalTables[$conn->connId][] = array("name" => "local_menu", "varname" => "dbusers_at_127_0_0_1__local_menu", "altvarname" => "local_menu", "connId" => "dbusers_at_127_0_0_1", "schema" => "", "connName" => "dbusers at 127.0.0.1");
		}
	}
