...
class tDAL
{
	var $tbldbusers_at_127_0_0_1__global_status;
	var $tbldbusers_at_127_0_0_1__global_users;
	var $tbldbusers_at_127_0_0_1__Home_v1091_settings;
	var $tbldbusers_at_127_0_0_1__home_v1091uggroups;
	var $tbldbusers_at_127_0_0_1__home_v1091ugmembers;
	var $tbldbusers_at_127_0_0_1__home_v1091ugrights;
	var $tbldbusers_at_127_0_0_1__local_menu;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "global_status", "varname" => "dbusers_at_127_0_0_1__global_status", "altvarname" => "global_status", "connId" => "dbusers_at_127_0_0_1", "schema" => "", "connName" => "dbusers at 127.0.0.1");
		...
		$this->lstTables[] = array("name" => "Home_v1091_settings", "varname" => "dbusers_at_127_0_0_1__Home_v1091_settings", "altvarname" => "Home_v1091_settings", "connId" => "dbusers_at_127_0_0_1", "schema" => "", "connName" => "dbusers at 127.0.0.1");
		$this->lstTables[] = array("name" => "home_v1091uggroups", "varname" => "dbusers_at_127_0_0_1__home_v1091uggroups", "altvarname" => "home_v1091uggroups", "connId" => "dbusers_at_127_0_0_1", "schema" => "", "connName" => "dbusers at 127.0.0.1");
		$this->lstTables[] = array("name" => "home_v1091ugmembers", "varname" => "dbusers_at_127_0_0_1__home_v1091ugmembers", "altvarname" => "home_v1091ugmembers", "connId" => "dbusers_at_127_0_0_1", "schema" => "", "connName" => "dbusers at 127.0.0.1");
		$this->lstTables[] = array("name" => "home_v1091ugrights", "varname" => "dbusers_at_127_0_0_1__home_v1091ugrights", "altvarname" => "home_v1091ugrights", "connId" => "dbusers_at_127_0_0_1", "schema" => "", "connName" => "dbusers at 127.0.0.1");
		$this->lstTables[] = array("name" => "local_menu", "varname" => "dbusers_at_127_0_0_1__local_menu", "altvarname" => "local_menu", "connId" => "dbusers_at_127_0_0_1", "schema" => "", "connName" => "dbusers at 127.0.0.1");
	}
