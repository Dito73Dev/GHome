...
$wGroupTableName = $ug_connection->addTableWrappers( "home_v1091uggroups" );
...
switch(postvalue("a"))
{
	...
	case "del":
		...
		$sql = "delete from ". $ug_connection->addTableWrappers( "home_v1091ugrights" ) 
	...
	case 'saveRights':
		...
		{	
			...
			$wRightsTableName = $ug_connection->addTableWrappers( "home_v1091ugrights" );
